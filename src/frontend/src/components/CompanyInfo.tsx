        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-brand/5 to-brand-dark/10 rounded-3xl p-8 border border-brand/20">
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed font-medium italic">
              "To eliminate food waste and promote healthier, smarter kitchens
              through innovative technology that keeps food fresh longer and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {team.map((member, i) => (
              ...
              >
                ...
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-3 ${member.badge}`}
                >
                  {member.title}
                </span>
                <h4 className="text-xl font-black text-charcoal mb-2">
                  {member.name}
                </h4>
