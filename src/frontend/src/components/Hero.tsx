    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl md:text-5xl font-bold text-charcoal mb-6 leading-tight">
          Stay Fresh. <span className="text-brand">Stay Smart.</span>{" "}
          <span className="text-brand-dark">Waste Nothing.</span>
        </h2>

        <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
          The world's first all-in-one smart fridge filter that combines odor
          absorption, ethylene gas detection, expiration tracking, and auto-mist
          cleansing — all in one device.
        </p>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 max-w-2xl mx-auto">
          {[
            ...
            <div
              key={stat.label}
              className="bg-white/80 backdrop-blur rounded-2xl p-4 shadow-md border border-brand/20"
            >
