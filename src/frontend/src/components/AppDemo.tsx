...
const alerts = [
  {
    ...
    emoji: "🚨",
    title: "1-Day Warning",
    message: "Strawberries expire tomorrow! Use them today.",
    time: "2 min ago",
  },
  {
    type: "warning",
    emoji: "⚠️",
    title: "3-Day Warning",
    message: "Spinach expires in 3 days. Plan a salad!",
    time: "1 hr ago",
  },
  {
    type: "warning",
  ...
  },
  {
    type: "info",
    emoji: "💨",
    title: "Auto-Mist Activated",
    message: "Odor detected. Mist cleanser released.",
    time: "5 hr ago",
  },
  {
    type: "success",
    emoji: "✅",
    title: "Scan Complete",
    message: "Greek Yogurt added to inventory.",
    time: "Yesterday",
  },
];
...
const recipes = [
  {
    ...
    steps:
      "Blend strawberries with banana and yogurt. Pour into bowl, top with granola and fresh berries.",
  },
  {
    emoji: "🥬",
    ...
    steps:
      "Sauté spinach, whisk eggs, pour over spinach, add cheese, fold and serve.",
  },
  {
    emoji: "🥛",
    ...
    steps:
      "Mix pasta with milk sauce, top with cheese, bake at 375°F for 20 minutes until golden.",
  },
];
      ...
      >
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-charcoal mb-4">
            The FreshGuard <span className="text-brand">Companion App</span>
          </h2>
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Track your food, get alerts before things expire, and discover
            recipes to use what you have.
          </p>
        </div>
                ...
                <div className="bg-gray-50 rounded-[2.4rem] overflow-hidden h-[580px] flex flex-col">
                  ...
                  <div className="bg-white px-4 pb-3 border-b border-gray-100">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-black text-charcoal text-base">
                        FreshGuard
                      </span>
                      <span className="ml-auto text-xs bg-brand/10 text-brand-dark px-2 py-0.5 rounded-full font-semibold">
                        Premium
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="bg-white flex border-b border-gray-100">
                    {(["inventory", "alerts", "recipes"] as Tab[]).map(
                      (tab) => (
                        <button
                          type="button"
                          key={tab}
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <p className="font-bold text-charcoal text-xs truncate">
                                  {item.name}
                                </p>
                              ...
                              <span
                                className={`text-xs font-bold px-2 py-1 rounded-full ${cfg.bg} ${cfg.text} flex-shrink-0`}
                              >
                                {cfg.label}
                              </span>
                            </div>
                    ...
                    {activeTab === "alerts" && (
                      <div className="p-3 space-y-2">
                        ...
                        {alerts.map((alert) => (
                          <div
                            key={alert.title}
                            className={`rounded-2xl p-3 border ${alertConfig[alert.type as keyof typeof alertConfig]}`}
                          >
                        ...
                        {recipes.map((recipe) => (
                          ...
                          >
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <div>
                                <p className="font-black text-charcoal text-xs">
                                  {recipe.title}
                                </p>
                                <span
                                  className={`text-xs px-2 py-0.5 rounded-full font-semibold ${recipe.tagColor}`}
                                >
                                  {recipe.tag}
                                </span>
                              </div>
                  ...
                  <div className="bg-white border-t border-gray-100 px-4 py-2 flex justify-around">
                    {[
                      ...
                      <button
                        type="button"
                        key={item.icon}
                        className={`p-2 rounded-xl text-lg ${item.active ? "bg-brand/10" : ""}`}
                      >
                        {item.icon}
                      </button>
                    ))}
            ...
            {[
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4
                      className={`font-black text-base mb-1 ${feature.active ? "text-brand-dark" : "text-charcoal"}`}
                    >
                      {feature.title}
                    </h4>
