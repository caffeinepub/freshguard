...
const features = [
  {
    ...
    description:
      "Eliminates fridge odors at the source with premium activated carbon technology.",
  },
  {
    emoji: "🔬",
    title: "Ethylene Gas Sensor",
    description:
      "Detects spoilage-causing ethylene gas and alerts you before food goes bad.",
  },
  {
    emoji: "📷",
    title: "Barcode Expiry Scanner",
    description:
      "Scans product barcodes to automatically track expiration dates in the app.",
  },
  {
    emoji: "📲",
    title: "Smart Bluetooth Alerts",
    description:
      "Sends real-time notifications to your phone when food is nearing expiry.",
  },
  {
    emoji: "💧",
    title: "Auto-Mist Cleansing System",
    description:
      "Releases a fine antimicrobial mist to keep your fridge fresh and bacteria-free.",
  },
];
...
export default function StorePage({ onBack }: StorePageProps) {
  ...
  const handleAddToCart = () => {
    setCartMessage(
      `✅ Added ${quantity} × FreshGuard Filter${quantity > 1 ? "s" : ""} to cart!`,
    );
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      (e.target as HTMLImageElement).src =
                        "/assets/generated/product-device.dim_600x600.png";
                    }}
                  />
                  {/* Badge */}
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                  The world's first 5-in-1 smart fridge filter. Eliminate odors,
                  detect spoilage, track expiry dates, receive smart alerts, and
                  keep your fridge fresh automatically.
                </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 text-lg max-w-xl mx-auto">
                Everything you need to keep your food fresh, tracked, and safe —
                built into a single smart device.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-black text-charcoal text-lg mb-2">
                    {feature.title}
                  </h3>
              ...
              <div className="bg-brand-gradient rounded-2xl p-6 flex flex-col justify-between text-white">
                <div>
                  ...
                  <p className="text-white/80 text-sm leading-relaxed">
                    Join thousands of households reducing food waste with
                    FreshGuard.
                  </p>
                </div>
                <button
        ...
        <section className="py-16 px-6 bg-charcoal text-white text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 mb-8 text-lg">
              The average household wastes $1,500/year on spoiled food.
              FreshGuard pays for itself in weeks.
            </p>
