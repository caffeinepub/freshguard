...
const demographics = [
  {
    emoji: "👨‍👩‍👧‍👦",
    label: "Health-Conscious Families",
    desc: "Families who prioritize fresh, healthy food for their loved ones",
  },
  {
    emoji: "💼",
    label: "Busy Professionals",
    desc: "Time-pressed individuals who need smart solutions to reduce waste",
  },
  {
    emoji: "📅",
    label: "Ages 25–50",
    desc: "Tech-savvy adults who embrace smart home technology",
  },
  {
    emoji: "🛒",
    label: "$150+/Month on Groceries",
    desc: "Households with significant grocery spend who want to protect their investment",
  },
];
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Millions of households are losing money to food waste every year.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-14">
          {demographics.map((item, i) => (
            ...
            >
              ...
              <div>
                <h4 className="font-black text-charcoal text-lg mb-1">
                  {item.label}
                </h4>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-brand to-brand-dark p-10 text-white text-center shadow-brand-glow">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl font-semibold text-white/90 max-w-3xl mx-auto leading-relaxed">
              ...
              that <strong>COMBINES</strong> odor absorption + gas detection +
              expiration tracking + auto-mist cleanse — all in{" "}
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={tag}
                  className="px-4 py-2 bg-white/20 backdrop-blur rounded-full text-sm font-bold border border-white/30"
                >
                  ✓ {tag}
                </span>
              ))}
