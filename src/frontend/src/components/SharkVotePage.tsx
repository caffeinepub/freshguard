...
export default function SharkVotePage({ onBack }: SharkVotePageProps) {
  ...
  const inPct =
    totalVotes === 0 ? 50 : Math.round((inVotes / totalVotes) * 100);
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #145214 0%, #1a6b1a 40%, #27ae60 80%, #2ecc71 100%)",
        }}
      >
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-5">
        ...
        <div className="flex items-center justify-between pt-4 px-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-black text-brand-dark ml-1">
              {inPct}%
            </span>
