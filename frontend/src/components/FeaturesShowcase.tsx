      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            Five powerful technologies packed into a single sleek unit that fits in any fridge.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {features.map((feature, i) => (
            ...
            >
              <div className={`w-14 h-14 rounded-2xl ${feature.iconBg} flex items-center justify-center text-3xl mb-5`}>
                {feature.emoji}
              </div>
              <h3 className="text-lg font-black text-charcoal mb-3">{feature.title}</h3>
